...
float power(float n) /* initiate the funktion of pow (pow of number 2)*/
{
...
float module(float c)/*The module function if the value is less to zero then we multiply this value by (-1) */
            {
        if(c>=0)
...
float summa(float n)/*The summa function  */
{
...
float cub(float n)/* cube function  */
        {
